...
```javascript
import reFilename from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-filename@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP, REGEXP_POSIX, REGEXP_WIN32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-filename@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/regexp-filename/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/regexp-filename/actions/workflows/test.yml?query=branch:v0.2.3
